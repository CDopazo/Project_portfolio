...
The national parks of **Venezuela** are **protected areas** in Venezuela covering a wide range of habitats. In 2007 there were **42 national parks**, covering **21.76% of Venezuela's territory.**

```{r echo=FALSE,message=FALSE, warning=FALSE,out.width="1000px"}
library(knitr)
include_graphics("images/venezuela_np_img.jpg")
```
...
* The national parks are **clustered**, **zoom is need to target a single National park**
* Every National Park icon has a **popup window with** a **photo** of the place, and an **URL linking to the Wikipedia** informative site of the National Park.
* There is a working **world minimap** on the bottom right corner of the screen that you can try.
...
library(knitr)
include_graphics("images/Rplot.png")
```
